.class synthetic Landroid/net/wimax/WimaxMonitor$1;
...
# static fields
.field static final synthetic $SwitchMap$android$net$wimax$DeviceStatusInfo$DeviceStatus:[I

.field static final synthetic $SwitchMap$android$net$wimax$DeviceStatusInfo$StatusReason:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/net/wimax/WimaxMonitor$1;->$SwitchMap$android$net$wimax$DeviceStatusInfo$StatusReason:[I

    :try_start_9
    sget-object v0, Landroid/net/wimax/WimaxMonitor$1;->$SwitchMap$android$net$wimax$DeviceStatusInfo$StatusReason:[I
    ...
    sput-object v0, Landroid/net/wimax/WimaxMonitor$1;->$SwitchMap$android$net$wimax$DeviceStatusInfo$DeviceStatus:[I
    ...
    sget-object v1, Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;->Ready:Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;
    ...
    sget-object v1, Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;->Connecting:Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;
    ...
    sget-object v1, Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;->Data_Connected:Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;
    ...
    sget-object v1, Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;->Disconnecting:Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;
    ...
    sget-object v1, Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;->Disconnected:Landroid/net/wimax/DeviceStatusInfo$DeviceStatus;
